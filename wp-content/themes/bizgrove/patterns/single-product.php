...
<h2 class="wp-block-heading has-text-align-center" style="font-style:normal;font-weight:500"> <?php echo esc_html__( 'Single Product', 'bizgrove' ); ?> </h2>
<!-- /wp:heading -->
...
<!-- wp:heading -->
<h2 class="wp-block-heading"><?php echo esc_html__( 'Related Products', 'bizgrove' ); ?></h2>
<!-- /wp:heading -->
