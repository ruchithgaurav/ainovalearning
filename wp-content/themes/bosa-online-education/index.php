...
?>
	...
	<div id="content" class="site-content">
		<div class="container">
			...
			<?php bosa_online_education_blog_advertisement_banner(); ?>
			...
			<!--Blog Events-->
			<?php get_template_part( 'template-parts/events/events' ); ?>
							...
							<?php
								if( !get_theme_mod( 'disable_pagination', false ) ):
									the_posts_pagination( array(
										...
										'next_text' => '<span>'.esc_html__( 'Next', 'bosa-online-education' ) .'</span><span class="screen-reader-text">' . esc_html__( 'Next page', 'bosa-online-education' ) . '</span>',
										'prev_text' => '<span>'.esc_html__( 'Prev', 'bosa-online-education' ) .'</span><span class="screen-reader-text">' . esc_html__( 'Previous page', 'bosa-online-education' ) . '</span>',
										'before_page_number' => '<span class="meta-nav screen-reader-text">' . esc_html__( 'Page', 'bosa-online-education' ) . ' </span>',
									));
								endif;
								wp_reset_postdata();
							?>
